...
export const InvestmentSummary = ({ result }: InvestmentSummaryProps) => {
  return (
    <div className="grid grid-cols-1 md:grid-cols-3 gap-4 lg:gap-8 mb-4 min-[2000px]:mb-8 animate-in fade-in slide-in-from-bottom-8 duration-500">
      ...
      <Card className="p-4 min-[2000px]:p-6 border-l-4 border-l-primary shadow-sm hover:shadow-md transition-shadow bg-primary/5 dark:bg-primary/10">
        <div className="flex items-center gap-3 min-[2000px]:gap-4"> 
          <div className="p-2 min-[2000px]:p-3 bg-primary/20 rounded-full">
            <PiggyBank className="w-5 h-5 min-[2000px]:w-6 min-[2000px]:h-6 text-primary" />
          </div>
          <div>
            <p className="text-xs min-[2000px]:text-sm text-muted-foreground font-medium uppercase tracking-wide">
              Wartość końcowa
            </p>
      ...
      <Card className="p-4 min-[2000px]:p-6 border-l-4 border-l-pink-500 shadow-sm hover:shadow-md transition-shadow">
        <div className="flex items-center gap-3 min-[2000px]:gap-4">
          <div className="p-2 min-[2000px]:p-3 bg-pink-100 dark:bg-pink-900/30 rounded-full">
      ...
      <Card className="p-4 min-[2000px]:p-6 border-l-4 border-l-primary shadow-sm hover:shadow-md transition-shadow">
        <div className="flex items-center gap-3 min-[2000px]:gap-4">
          <div className="p-2 min-[2000px]:p-3 bg-primary/20 dark:bg-primary/10 rounded-full">
          ...
          <div>
            ...
            <p className="text-xl min-[2000px]:text-2xl font-bold text-primary mt-0.5 min-[2000px]:mt-1">
